...
namespace OpenTap.Plugins.PNAX
{
    ...
    public partial class PNAX : ScpiInstrument
    {
        ...
        public void ReceiverLevelingType(int Channel, string port, ReceiverLevelingTypeEnum receiverLevelingType)
        {
        ...
        public void ReceiverLevelingSourceALC(int Channel, string port, SourceLevelingModeType sourceLeveling)
        {
        ...
        public void ReceiverLevelingFrequency(int Channel, string port, ReceiverLevelingFTypeEnum ftype)
        {
