...
namespace OpenTap.Plugins.PNAX
{
    [Display(
        ...
        Description: "Deletes all traces, measurements, and windows. In addition, resets the analyzer to factory defined default settings and creates a S11 measurement named \"CH1_S11_1\". For a list of default settings, see Preset."
