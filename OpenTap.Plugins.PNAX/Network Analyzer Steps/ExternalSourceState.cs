...
{
    [Display("External Source State", Groups: new[] { "Network Analyzer" }, Description: "Set and return the state of activation of the device. When SYST:CONF:EDEV:IOEN = ON, and this command is set to ON, the VNA will attempt communication with the external device." +
