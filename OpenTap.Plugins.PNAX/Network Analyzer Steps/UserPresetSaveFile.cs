...
{
    [Display(
        "User Preset Save File",
        Groups: new[] { "Network Analyzer" },
        Description: "Saves the current instrument settings as UserPreset.sta.  Subsequent execution of SYSTem:UPReset will cause the VNA to assume this instrument state."
