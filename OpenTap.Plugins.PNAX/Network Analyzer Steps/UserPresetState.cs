...
namespace OpenTap.Plugins.PNAX
{
    [Display(
        ...
        Description: "Performs a User Preset. There must be an active User Preset state file (see Load and Save) or an error will be returned"
    ...
    public class UserPresetState : TestStep
    {
        ...
        [Display("User Preset State", Group: "Settings", Order: 10)]
        public bool PresetState { get; set; }

        #endregion

        public UserPresetState()
        {
            PresetState = false;
        }
        ...
        {
            PNAX.UserPresetState(PresetState);
