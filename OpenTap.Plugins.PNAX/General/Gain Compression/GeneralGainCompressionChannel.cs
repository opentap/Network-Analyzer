...
namespace OpenTap.Plugins.PNAX
{
    ...
    public class GeneralGainCompressionChannel : PNABaseStep
    {
        ...
        public GeneralGainCompressionChannel()
        {
            ...
            // Compression
            GeneralGainCompression compression = new GeneralGainCompression
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Power
            GeneralGainCompressionPower power = new GeneralGainCompressionPower
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Frequency
            GeneralGainCompressionFrequency frequency = new GeneralGainCompressionFrequency
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Traces
            GeneralGainCompressionNewTrace gainCompressionNewTrace =
                new GeneralGainCompressionNewTrace
                {
                    IsControlledByParent = true,
                    Channel = this.Channel,
                };
        ...
        public override void Run()
        {
            ...
            PNAX.ScpiCommand(
                $"CALCulate{Channel}:CUST:DEFine \'CH{Channel}_DUMMY_S21_1\',\'Gain Compression\',\'S21\'"
            );
