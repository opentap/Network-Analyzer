...
{
    [Display(
        "Noise Figure Cold Source Channel",
    ...
    public class GeneralNoiseFigureChannel : PNABaseStep
    {
        ...
        public GeneralNoiseFigureChannel()
        {
            ...
            // NoiseFigure
            GeneralNoiseFigure noiseFigure = new GeneralNoiseFigure
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Power
            GeneralNoiseFigurePower power = new GeneralNoiseFigurePower
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Frequency
            GeneralNoiseFigureFrequency frequency = new GeneralNoiseFigureFrequency
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
            // Trace
            GeneralNoiseFigureNewTrace noiseFigureNewTrace = new GeneralNoiseFigureNewTrace
            {
                IsControlledByParent = true,
                Channel = this.Channel,
            };
        ...
        public override void Run()
        {
            ...
            PNAX.ScpiCommand(
                $"CALCulate{Channel}:CUST:DEFine \'CH{Channel}_DUMMY_NF_1\',\'Noise Figure Cold Source\',\'NF\'"
            );
