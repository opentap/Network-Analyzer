...
namespace OpenTap.Plugins.PNAX
{
    ...
    public class DIQSources : PNABaseStep
    {
        ...
        {
            DIQSource newSource = ConfigureChildStep(new DIQSource { SourceName = "Source" });
        ...
        public DIQSources()
        {
            ...
            // Add Default Sources
            DIQSource newSource = ConfigureChildStep(new DIQSource { SourceName = "Port 1" });
            newSource.SourceState = DIQPortStateEnumtype.Auto;
            this.ChildTestSteps.Add(newSource);
            newSource = ConfigureChildStep(new DIQSource { SourceName = "Port 2" });
            ...
            newSource.RRec = "a2";
            this.ChildTestSteps.Add(newSource);
            newSource = ConfigureChildStep(new DIQSource { SourceName = "Port 3" });
            newSource.SourceState = DIQPortStateEnumtype.Off;
            ...
            newSource.RRec = "a3";
            this.ChildTestSteps.Add(newSource);
            newSource = ConfigureChildStep(new DIQSource { SourceName = "Port 4" });
            newSource.SourceState = DIQPortStateEnumtype.Off;
            ...
            newSource.RRec = "a4";
            this.ChildTestSteps.Add(newSource);
            newSource = ConfigureChildStep(new DIQSource { SourceName = "Port 1 Src2" });
            newSource.SourceState = DIQPortStateEnumtype.Off;
            ...
            newSource.RRec = "a1";
            this.ChildTestSteps.Add(newSource);
            newSource = ConfigureChildStep(new DIQSource { SourceName = "Source3" });
            newSource.SourceState = DIQPortStateEnumtype.Off;
            newSource.ReferencedTo = "Port 4";
            newSource.rCont = "a1";
            newSource.rRef = "a4";
